...
class tov_ode {
  ...
  using state_t = std::array<value_t, NUM_VARS>;
  ...
  tov_ode(real_t rho_center_, eos_barotr eos_, real_t origin_margin=0.);
  ...
  auto m_by_r3_approx_origin(real_t rsqr, real_t lambda, 
  ...
  auto drsqr_ybnd_approx_origin(real_t ybnd, real_t rsqr, 
